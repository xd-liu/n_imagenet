...
class CNNContainer(ModelContainer):
    ...
    def gen_model(self):
        ...
        if self.cfg.model == 'ResNet18':
            model = resnet18(pretrained=use_pretrained, num_classes=pretrained_num_classes)
        elif self.cfg.model == 'ResNet34':
            model = resnet34(pretrained=use_pretrained, num_classes=pretrained_num_classes)
        elif self.cfg.model == 'ResNet50':
            model = resnet50(pretrained=use_pretrained, num_classes=pretrained_num_classes)
        elif self.cfg.model == 'ResNet101':
            model = resnet101(pretrained=use_pretrained, num_classes=pretrained_num_classes)
